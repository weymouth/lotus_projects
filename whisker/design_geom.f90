...
! -- write the motion
  ...
  open(7,file='inp.mot')
  call pathSet_read(7,motion(1),.true.)
  call pathSet_read(7,motion(2),.true.)
  call pathSet_read(7,motion(3),.true.)
  close(7)

  print *, motion(2).at.0.0D0
  print *, motion(2).at.0.1D0
  print *, motion(2).at.0.2D0
  stop
