...
!-------------------------------------------------------------
  subroutine init_solver
    ...
    implicit none
    real(8) :: tol = 1e-6
    integer :: mx = 50,btypes(-ndims:ndims)

!!$    btypes = 0; btypes(ndims) = 1  ! hard coded in bytpes for direct-forcing test (they aren't coming from beta anymore)
    btypes = 1
    ...
    call init_mympi(set_btypes=btypes,set_COMM=mympi_COMM())
