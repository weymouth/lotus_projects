program swimming_plate
  ...
  !
    real,parameter     :: L=128, nu=L/Re
    real, parameter    :: finish=1., lbox(3)=[0.,-0.2,0.], ubox(3)=[1.,0.2,0.5]
    integer            :: b(3) = [4,2,1]
  !
  ! -- Hyperparameters
    real, parameter    :: thicc=0.03*L
    real, parameter    :: A = 0.1*L, St_d = 0.3, k_x=32.5, k_z=32.0, h_roughness=0.005
